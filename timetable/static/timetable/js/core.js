...
// method
ClassELement.prototype.makeItemHtml= function(){
  html = '<div class="classitem" id='+this.classcode+'><div class="content">\
  <p>'+this.classname+'<br>'+this.prof+'<br>'+this.classroom+'<br></p></div></div>';
